...
export default function PrivacyPolicy() {
  return (
    <Box>
      <Head>
        <title>Subly - Privacy policy</title>
        <meta
          name="description"
      ...
      >
        ...
        <Box>
          ...
          <List spacing={4} fontSize="md" pl={4} color="blue.600">
            <ListItem>
        ...
        <Heading size="lg" id="collection-of-personal-information">
          Collection of personal information
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <UnorderedList spacing={4} fontSize="lg" pl={4}>
          <ListItem>
        ...
        <Text fontSize="lg" lineHeight="9">
          ...
          platforms, public databases, third-party data providers, and our joint
        ...
        <Heading size="lg" id="use-and-processing-of-collected-information">
          Use and processing of collected information
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <UnorderedList spacing={4} fontSize="lg" pl={4}>
          ...
          <ListItem>Improve products and services</ListItem>
          <ListItem>Send marketing and promotional communications</ListItem>
          <ListItem>Request user feedback</ListItem>
          <ListItem>Improve user experience</ListItem>
          <ListItem>Protect from abuse and malicious users</ListItem>
          <ListItem>Run and operate the Website and Services</ListItem>
        </UnorderedList>
        <Text fontSize="lg" lineHeight="9">
        ...
        <Heading size="lg" id="payment-processing">
          Payment processing
        </Heading>
        <Text fontSize="lg" lineHeight="9">
          ...
          processors (&#8220;Payment Processors&#8221;) to assist us in
        ...
        <Text fontSize="lg" lineHeight="9">
          ...
          the Website and Services are also in compliance with strict
          vulnerability standards in order to create as secure of an environment
          as possible for Users. We will share payment data with the Payment
          Processors only to the extent necessary for the purposes of processing
        ...
        <Text fontSize="lg" lineHeight="9">
          ...
          The Payment Processors&#8217; use of your Personal Information is
          governed by their respective privacy policies which may or may not
          contain privacy protections as protective as this Policy. We suggest
          that you review their respective privacy policies.
        </Text>
        <Heading size="lg" id="managing-information">
        ...
        <Heading size="lg" id="disclosure-of-information">
        ...
        <Heading size="lg" id="retention-of-information">
        ...
        <Heading size="lg" id="transfer-of-information">
        ...
        <Heading size="lg" id="data-protection-rights-under-the-gdpr">
          Data protection rights under the GDPR
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <Heading size="lg" id="california-privacy-rights">
        ...
        <Heading size="lg" id="how-to-exercise-your-rights">
          How to exercise your rights
        </Heading>
        <Text>
        ...
        <Heading size="lg" id="data-analytics">
          Data analytics
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <Heading size="lg" id="do-not-track-signals">
        ...
        <Heading size="lg" id="social-media-features">
        ...
        <Heading size="lg" id="email-marketing">
          Email marketing
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <Heading size="lg" id="affiliate-links">
          Affiliate links
        </Heading>
        <Text fontSize="lg" lineHeight="9">
          We may engage in affiliate marketing and have affiliate links present
          on the Website and Services for the purpose of being able to offer you
        ...
        <Heading size="lg" id="information-security">
        ...
        <Heading size="lg" id="data-breach">
          Data breach
        </Heading>
        <Text fontSize="lg" lineHeight="9">
        ...
        <Text fontSize="lg" lineHeight="9">
          <a
            href="https://app.websitepolicies.com/dsar/view/b3xbtl2a"
            target="_blank"
