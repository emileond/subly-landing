  ...
  return (
    <Box>
      ...
      >
        ...
        <Heading size="md">Log Data</Heading>
        <p>
        ...
        <Heading size="md">Device Data</Heading>
        <p>
        ...
        <Heading size="sm">Security of Your Personal Information</Heading>
        <p>
        ...
        <Heading size="sm">How Long We Keep Your Personal Information</Heading>
        <p>
        ...
        <Heading size="md">Use of Cookies</Heading>
        <p>
        ...
        <Heading size="md">Changes to This Policy</Heading>
        <p>
