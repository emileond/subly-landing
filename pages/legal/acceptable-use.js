...
export default function AcceptableUse() {
  return (
    <Box>
      <Head>
        <title>Subly - Acceptable Use Policy</title>
      ...
      >
        ...
        <p>This policy was last reviewed on 16 October 2023.</p>
        <Heading size="md">Fair use</Heading>
        <p>
          We provide our facilities with the assumption your use will be
          &quot;business as usual&quot;, as per our offer schedule. If your use
          is considered to be excessive, then additional fees may be charged or
        ...
        <p>
          ...
          their users (&quot;end-users&quot;) to likewise engage our Products
          with similar intent.
        </p>
        <Heading size="md">Customer accountability</Heading>
        <p>
        ...
        <Heading size="md">Prohibited activity</Heading>
        <Heading size="sm">
        ...
        <Heading size="md">SPAM and unauthorized message activity</Heading>
        <p>
        ...
        <p>
          ...
          mailing lists or telephone number lists (&quot;messaging lists&quot;).
          This includes but isn’t limited to subscribing email addresses or
          telephone numbers to any messaging list without the permission of the
          email address or telephone number owner, and storing any email
          ...
          opt-in&quot;. Verification of the address or telephone number owner’s
          express permission must be available for the lifespan of the messaging
          list.
        </p>
        <p>
        ...
        <ol>
          ...
          <li>
            ...
            violence, depict a violent act, depict child pornography or threaten
        ...
        <Heading size="sm">
          Unauthorized use of Subly Financial, Inc. property
        </Heading>
        <p>
          We prohibit the impersonation of Subly Financial, Inc., the
          representation of a significant business relationship with Subly
          Financial, Inc., or ownership of any Subly Financial, Inc. property
          (including our Products and brand) for the purpose of fraudulently
          gaining service, custom, patronage or user trust.
        </p>
        <Heading size="sm">About this policy</Heading>
        <p>
